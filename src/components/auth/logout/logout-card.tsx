  ...
  return (
    <Card {...props}>
      <CardHeader className="text-center">
        <CardTitle>Has sido desconectado</CardTitle>
        <CardDescription>¡Esperamos verte pronto!</CardDescription>
      </CardHeader>
      <CardContent>
        <div className="flex flex-col items-center space-y-2 rounded-xl bg-muted p-4">
          ...
          <span className="text-sm font-medium">Cierre de sesión seguro</span>
          <span className="text-center text-xs text-muted-foreground">
            La sesión ha terminado.
          </span>
        </div>
        <p className="mt-4 text-center text-sm text-muted-foreground">
          Serás redirigido en <span className="font-medium">{countdown}</span>{' '}
          segundos.
        </p>
      </CardContent>
      <CardFooter>
