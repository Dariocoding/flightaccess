  ...
  return (
    <ul className="list-none space-y-1 py-2">
      ...
      >
        ...
        <p className="text-sm">Combinar mayúsculas y minúsculas</p>
      </li>
      <li
        className={cn(
          'flex flex-row items-center px-4',
      ...
      >
        ...
        <p className="text-sm">Mínimo {MINIMUM_PASSWORD_LENGTH} caracteres</p>
      </li>
      <li
        className={cn(
          'flex flex-row items-center px-4',
      ...
      >
        ...
        <p className="text-sm">Contener al menos un número</p>
      </li>
    </ul>
  );
}
