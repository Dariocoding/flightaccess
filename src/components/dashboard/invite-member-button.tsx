...
import { InviteMemberModal } from '@/app/dashboard/settings/components/organization/members/invite-member-modal';
      ...
      <Tooltip delayDuration={0}>
        <TooltipTrigger asChild>
          ...
          >
            ...
            <span className="sr-only">Invitar miembro</span>
          </Button>
        </TooltipTrigger>
        <TooltipContent side="right">Invitar miembro</TooltipContent>
      </Tooltip>
    );
  }
